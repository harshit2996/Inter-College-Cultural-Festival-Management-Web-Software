...
if (isset($_POST['signup'])) {
	...
	if (!$error) {
		if(mysqli_query($con, "INSERT INTO users(name,email,password) VALUES('" . $name . "', '" . $email . "', '" . md5($password) . "')")) {
			$successmsg = "Successfully Registered! <a href='login1.php'>Click here to Login</a>";
		} else {
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbar1">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a class="navbar-text navbar-toggle active" href="register.php"><font size="5" >Register</font></a></li>
...
<div align="center"><b>REGISTRATION PAGE</b></div>
<div class="container">
	<div class="row">
